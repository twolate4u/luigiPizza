...
//        Menü:
            System.out.println();
            System.out.println("Erstelle eine neue Pizza für: " + orderName);
            System.out.println("Pizza No.: " + (order.getOrderList().indexOf(pizza)+1)+"\n"); // +1 weil sonst die erste Pizza 0 ist.
            System.out.println("Die Zutatenliste zeigt an, aus welchen Toppings Sie wählen können.\n");
            ...
            System.out.println("Mit <Zutaten> können Sie die Zutatenliste erneut aufrufen. \nMit dem Befehl <fertig> schließen Sie die Auswahl ab.");
            ...
            while (true) {
                ...
                if (command.equals("nein")) {
                    System.out.println("Möchten Sie die Bestellung abschicken <Ja> <Nein>?");
                    if (command.equals("ja")) {
                        System.out.println("Sie werden zur Kasse weitergeleitet");
                        //AUSGABE PREIS
                        System.out.println("Die Pizza" + order.getOrderList().indexOf(pizza)+1 + "kostet" + "XXXX Euro"+ \ "Bitte bezahlen Sie via PayPal");;
                        // AUFFORDERUNG BEZAHLUNG
                        System.out.println("Bitte geben sie ");
                    }
                    else if (command.equals("nein")) {
                    }
                    //ZURÜCK ZUM BEARBEITEN
                    ///continue ;
                    else {
                        System.out.println("ungültiger Befehl. <ja>: Bestellung abschicken. <nein>: Zurück zur Pizza.");
                        break;
                    }
                }
